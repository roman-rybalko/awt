			...
			<div class="col-lg-4">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<br/>
						<a href="mailto:billing@advancedwebtesting.com?subject=User%20request:&amp;body=Login:%20{//user/@login}%0aTransaction ID:%0a%20Pending Transaction ID:%0a%20Subscription ID:%0a%20">
