...
create table test_actions(test_id integer not null, type varchar(256) not null, selector varchar(4096), data varchar(4096), user_data varchar(4096), action_id integer not null);
