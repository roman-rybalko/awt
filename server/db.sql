...
create table tasks(user_id integer not null, test_id integer not null, type varchar(256) not null, debug integer(1), status integer not null, data varchar(256), task_id integer primary key auto_increment not null, time integer not null);
