...
create table settings(user_id integer primary key not null, email varbinary(256), task_fail_email_report integer(1), task_success_email_report integer(1), task_fail_emails varbinary(1024), task_success_emails varbinary(1024), language varbinary(5), undeletable integer(1));
