...
#### Владелец сайта
Предложение: функциональный мониторинг сайта

Данный клиент имеет довольно аргументированные возражения:
1. У нас уже есть мониторинг. Яндекс-метрика бесплатно мониторит наш сайт.
 Суть в том, что владелец сайта не особо понимает разницу между функционалным мониторингом
 и мониторингом доступности. Да ему это особо и не надо, см. след. п.
2. В час ночи клиент узнал, что у него рухнул сайт. Что ему делать?
 Владелец сайта зачастую нанимает кого-то для обслуживания своего сайта.
 Сайт упал - чинит подрядчик. В таком случае клиенту особо и не интересно
 знать, что именно произошло с сайтом. Он все вопросы решает с подрядчиком.
 А подрядчик - это веб-студия.

#### Веб-студия, разработчики
Предложение: функциональное тестирование и мониторинг, вы пишете код - мы пишем тесты

Некоторые веб-студии умудряются взимать плату за каждое востановление функционирования сайта.
Т.е. в таких условиях веб-студия наоборот заинтересована, что-бы сайт падал чаще.
Этот подход выгоден всем, если в сотрудничестве задействована коррупционная схема.
Такие нам не нужны.
