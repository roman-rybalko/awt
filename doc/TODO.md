...
44. исправить таймаут теста у server
45. исправить stats xml и db (tasks_added -> tasks_started)
46. добавить параметр xml для отключения внутреннего xslt в ajax-запросах на мобильниках
