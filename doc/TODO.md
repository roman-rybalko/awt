...
37. компрессия данных БД (selector, data, user_data) (снижается надежность, т.к. данные в БД закодированы что осложняет их поиск и восстановление при сбое) (?)
38. длинные varchar -> varbinary
