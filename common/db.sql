...
create table task_actions(task_id integer not null, type varchar(255) not null, selector varchar(255), data varchar(255), action_id integer not null, scrn_filename varchar(255), failed integer(1));
